...
<br>
A modern and secure web application designed to manage and streamline the process of borrowing and managing books online.
...
* Protected Profile Management<br>
*   Dynamic Book Sliders<br>
*  Dynamic Book Showcase <br>
*  Controlled Registration Flow<br>
*   Fully Responsive & Beautiful UI<br>
